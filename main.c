...
unsigned char sensorLessCheck;
char ADCPortNum = 0;
const unsigned char sensorLess1[6] = {
    0b00000011,
    0b00000001,
    0b00000101,
    0b00000100,
...
const unsigned char sensorLess2[6] = {
    0b00000010,
    0b00000011,
    0b00000001,
    0b00000101,
...
void interrupt isr() {
    if (PIR1bits.ADIF) {
        ...
        if (ADCPortNum >= 2) {
            ...
            sensorLessCheck = 0b00000000;
            sensorLessCheck += (ADCON[0] > (ADCON[1] + ADCON[2]) >> 1) ? 0b00000001 : 0;
            sensorLessCheck += (ADCON[1] > (ADCON[0] + ADCON[2]) >> 1) ? 0b00000010 : 0;
            sensorLessCheck += (ADCON[2] > (ADCON[0] + ADCON[1]) >> 1) ? 0b00000100 : 0;
            if (sensorLess1[0] == sensorLessCheck) {
                PORTBbits.RB3 = 1;
            } else {
                PORTBbits.RB3 = 0;
            }
